...
public class DeliveryManager {
    ...
    public void readFileAndSetSneakersDeliveryMap() {
        try (BufferedReader fis = new BufferedReader(new FileReader("src/assignments/week1/assignment1/leaderProject/snow/nike-sneaker-delivery-infos.txt"))) {
    ...
    public void writeTodayDeliveryClip() {
        String filename = "src/assignments/week1/assignment1/leaderProject/snow/delivery-manager-record.txt"; // 출력할 파일의 이름
