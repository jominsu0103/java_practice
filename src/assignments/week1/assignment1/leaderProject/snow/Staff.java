...
public class Staff {
    ...
    public void readFileAndSetSneakerInfoMap() {
        try (BufferedReader fis = new BufferedReader(new FileReader("src/assignments/week1/assignment1/leaderProject/snow/nike-sneaker-characters.txt"))) {
    ...
    public void readFileAndSetSneakersStockMap() {
        try (BufferedReader fis = new BufferedReader(new FileReader("src/assignments/week1/assignment1/leaderProject/snow/nike-sneaker-stocks.txt"))) {
    ...
    public void writeTodaySalesClip() {
        String filename = "src/assignments/week1/assignment1/leaderProject/snow/staff-sales.txt"; // 출력할 파일의 이름
    ...
    public void writeTodaySales() {
        String filename = "src/assignments/week1/assignment1/leaderProject/snow/today-sales.txt";
    ...
    public void writeTodayStocks() {
        String filename = "src/assignments/week1/assignment1/leaderProject/snow/nike-sneaker-stocks-2.txt";
