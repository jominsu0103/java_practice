...
public class StringTest {
    public static void main(String[] args) {
        ...
        System.out.println("str1과 str2의 참조 비교결과:" + (str1 == str2 ? "같은참조" : "다른참조"));
        System.out.println("str1과 str2의 참조 비교결과:" + (str1 == str3 ? "같은참조" : "다른참조"));

//TODO: str1 <-> str2, str1 <-> str3를 equals으로 값을 비교 및 출력해주세요 .
        System.out.println("str1과 str2의 비교 결과:" + (str1.equals(str2) ? "같음" : "다름"));
        System.out.println("str1과 str2의 비교 결과:" + (str1.equals(str3) ? "같음" : "다름"));
